...
- Στον φάκελο που θέλουμε να ανεβάσουμε τις φωτογραφίες μας από τα στίκερς, δημιουργούμε και αποθηκεύουμε το αρχείο **index.php** με το παρακάτω περιεχόμενο ώστε να πάρουμε μήνυμα επιτυχούς ή εσφαλμένης αποστολής.
```
<?php
...
if(move_uploaded_file($_FILES['file']['tmp_name'], $file_path)) {
    $result = array("success" => "Photo successfully uploaded");
} else{
    $result = array("success" => "error uploading photo");
}
